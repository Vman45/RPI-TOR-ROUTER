/#!/bin/sh
#This script create for auto setup Raspberry Pi 3 Tor Wifi Router
# Author - Koustav Kumar Mondal

clear
/bin/cat <<'Takmashhido'
 _____     _                        _     _     _     _
|_   _|_ _| | ___ __ ___   __ _ ___| |__ | |__ (_) __| | ___
  | |/ _` | |/ / '_ ` _ \ / _` / __| '_ \| '_ \| |/ _` |/ _ \
  | | (_| |   <| | | | | | (_| \__ \ | | | | | | | (_| | (_) |
  |_|\__,_|_|\_\_| |_| |_|\__,_|___/_| |_|_| |_|_|\__,_|\___/
Takmashhido
if [ $? != 0 ] 
then
...
echo "Reboot your system for start PITOR-WIFI"
echo ""
echo "Don't forget to Follow https://github.com/TakMashhido"
echo ""
